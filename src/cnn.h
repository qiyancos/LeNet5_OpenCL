...
#define width_image_C1_CNN              28//卷积层1
#define height_image_C1_CNN		    28
#define width_image_S2_CNN		    14//池化层1
#define height_image_S2_CNN		    14
#define width_image_C3_CNN		    10//卷积层2
#define height_image_C3_CNN		    10
#define width_image_S4_CNN		    5//池化层2
#define height_image_S4_CNN		    5
#define width_image_C5_CNN		    1//全连接1
#define height_image_C5_CNN		    1
#define width_image_output_CNN		1//全连接2
...
extern cl_program program1;//kernel.cl
extern cl_program program2;//backward.cl
extern cl_program program3;//update_delta.cl
//Forward_C1()
extern cl_kernel kernel1;
extern cl_mem clbuf_data_single_image;  // Input array on the device
extern cl_mem clbuf_weight_C1;  // Input array on the device
extern cl_mem clbuf_bias_C1;  // Input array on the device
extern cl_mem clbuf_neuron_C1; // Output array on the device
//Forward_S2()
extern cl_kernel kernel2; 
extern cl_mem clbuf_weight_S2;  
extern cl_mem clbuf_bias_S2;  
extern cl_mem clbuf_neuron_S2; 
//Forward_C3()
extern cl_kernel kernel3;
extern cl_mem clbuf_weight_C3;  
extern cl_mem clbuf_bias_C3;  
extern cl_mem clbuf_neuron_C3; 
extern cl_mem clbuf_tbl;
//Forward_S4()
extern cl_kernel kernel4; 
extern cl_mem clbuf_weight_S4;  
extern cl_mem clbuf_bias_S4;  
extern cl_mem clbuf_neuron_S4; 
//Forward_C5()
extern cl_kernel kernel5; 
extern cl_mem clbuf_weight_C5;  
extern cl_mem clbuf_bias_C5;  
extern cl_mem clbuf_neuron_C5; 
//Forward_output()
extern cl_kernel kernel6; 
extern cl_mem clbuf_weight_output;  
extern cl_mem clbuf_bias_output;  
extern cl_mem clbuf_neuron_output;
//Backward_output()
extern cl_kernel kernel7; 
extern cl_mem clbuf_delta_neuron_output; 
extern cl_mem clbuf_data_single_label;   
//Backward_C5()
extern cl_kernel kernel8; 
extern cl_mem clbuf_delta_neuron_C5; 
extern cl_mem clbuf_delta_weight_output; 
//Backward_S4()
extern cl_kernel kernel9; 
extern cl_mem clbuf_delta_neuron_S4; 
extern cl_mem clbuf_delta_weight_C5; 
//extern cl_mem clbuf_delta_bias_C5; 
//Backward_C3()
extern cl_kernel kernel10; 
extern cl_mem clbuf_delta_neuron_C3; 
extern cl_mem clbuf_delta_weight_S4; 
//Backward_S2()
extern cl_kernel kernel11;
extern cl_kernel kernel12;
extern cl_mem clbuf_delta_neuron_S2; 
extern cl_mem clbuf_delta_weight_C3;
//Backward_C1()
extern cl_kernel kernel13; 
extern cl_mem clbuf_delta_neuron_C1; 
extern cl_mem clbuf_delta_weight_S2;
//Backward_input()
extern cl_kernel kernel14;
extern cl_kernel kernel15;
extern cl_mem clbuf_delta_neuron_input; 
extern cl_mem clbuf_delta_weight_C1;

//others
extern cl_kernel kernel16;
extern cl_kernel kernel17;
extern cl_mem clbuf_delta_bias_output;
extern cl_mem clbuf_delta_bias_C5;
extern cl_mem clbuf_delta_bias_S4;
extern cl_mem clbuf_delta_bias_C3;
extern cl_mem clbuf_delta_bias_S2;
extern cl_mem clbuf_delta_bias_C1;

extern cl_mem clbuf_E_weight_output;
extern cl_mem clbuf_E_weight_C5;
extern cl_mem clbuf_E_weight_S4;
extern cl_mem clbuf_E_weight_C3;
extern cl_mem clbuf_E_weight_S2;
extern cl_mem clbuf_E_weight_C1;
 
extern cl_mem clbuf_E_bias_output;
extern cl_mem clbuf_E_bias_C5;
extern cl_mem clbuf_E_bias_S4;
extern cl_mem clbuf_E_bias_C3;
extern cl_mem clbuf_E_bias_S2;
extern cl_mem clbuf_E_bias_C1;

extern int dcmp(double x);
//
class CNN {
public:
	CNN();
...
private:
	...
	float weight_C1[len_weight_C1_CNN];//连接权值
	float bias_C1[len_bias_C1_CNN];    //连接bias值
