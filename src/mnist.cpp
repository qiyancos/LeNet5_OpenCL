...
bool CNN::getSrcData()
{
	...
	std::string filename_train_images = "Release/data/train-images-idx3-ubyte";
	std::string filename_train_labels = "Release/data/train-labels-idx1-ubyte";
	...
	std::string filename_test_images = "Release/data/t10k-images-idx3-ubyte";
	std::string filename_test_labels = "Release/data/t10k-labels-idx1-ubyte";
